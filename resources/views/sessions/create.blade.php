...
<div class="input-group my-5 ml-4">
      ...
      <form class="border p-5 col-sm-5 mr-4 "  action="/login" method="post">
        {{ csrf_field() }}
          ...
          <div class="justify-content-between">
              ...
              <div>
                  <a href="/forgot-password" style="color: #A55FA5;font-weight: 600">Forgot password?</a>
              </div>
          </div>
      ...
      <!--Daftar Akun-->
      <div class="border col-sm-5 d-flex ml-4 justify-content-center align-items-center">
        <div class="text-center">
            <h2 class="font-weight-bold">Daftar Akun</h2>
            <small class="text-muted">Klik tombol di bawah untuk mulai membuat akun</small>
            <div class="mt-4">
