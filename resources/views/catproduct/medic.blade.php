...
<div class="row row-cols-1 row-cols-md-3  g-4 mb-5">
    ...
    <a href="detail/{{ $item->id }}" class="col ">
        <div class="card h-100 each-product">
            <img src="{{ '/storage/' .$item->image }}" style="width: 100%; max-width: 300px" class="card-img-top m-auto"
                alt="Gambar Produk">
            <div class="card-body">
                <div class="border rounded text-center mb-2 rounded-pill" style="width: 30%; margin-bottom: 10px;color: #C8A2C8;">
                    {{ $item->kategori }}</div>
