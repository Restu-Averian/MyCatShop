...
<div class="input-group my-5 ml04">
      <!--Masuk-->

      <div class="border col-sm-5  d-flex  align-items-center justify-content-center" >
          
        <div class="text-center">
            <div class="mb-4">
                <h2 class="font-weight-bold">Sudah Punya Akun ?</h2>
                <small class="text-muted">Klik tombol di bawah untuk masuk ke akunmu</small>
