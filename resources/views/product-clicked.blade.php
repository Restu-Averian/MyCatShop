    ...
    <div class="container product_data " style="margin-top: 30px;">
        ...
        <hr>
            ...
            <div class="col" style="margin-top: -5px">
                @if ($products->id === 1)
                    <div class="alert alert-success">Hawo</div>
                @endif
                ...
                <h2 style="color:#A55FA5; font-weight: bold;" >Rp {{ $products->harga }}</h2>
                <div class="row" >
                    <div class="col-4 my-4">
                        ...
                        <div class="input-group" >
                            ...
                            <input type="number" id="qty-input" name="qty-input" class="form-control changeQuantity qty-input input-number text-center"
                ...
                <div class="d-flex ">
                        ...
                        {{-- <a href="/checkout" type="button" class="btn btn-primary font-weight-bold " style="background-color: #A55FA5;" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-label="Close" >Beli Langsung</a> --}}
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <div class="mr-auto">
                                        <small style="color:#A55FA5; font-weight: bold;"><b>Jumlah Pembayaran : </b> <h4 class="d-inline">Rp {{ $products->harga * $products->kuantitas }}</h4></small>
                                    </div>
                ...
                <div id="tabs">
                    ...
                    <div class="tab-content" >
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <form action="/detail/{{ $products->id }}/reviews" method="POST" class="my-4" onsubmit="return validateForm();" name="myForm" >
                                {{ csrf_field() }}
                                <label for="body">Ulasan</label>
                                <textarea class="form-control body" name="body" placeholder="Beri ulasan terhadap produk ini" id="body" style="z-index: -999"></textarea>
                                <script>
                                    function validateForm() {
                                        let x = document.forms["myForm"]["body"].value;
                                            if (x == "") {
...
<script>
    $(document).ready(function() {
        ...
        $('.increment-btn').click(function(e) {
            ...
            var inc_value=$(':root').find('.qty-input').val();
        ...
        $('.decrement-btn').click(function(e) {
            ...
            var dec_value=$(':root').find('.qty-input').val();
