        ...
        <div class="col-lg-10">
            <div class="card my-4">
                ...
                <div class="d-flex justify-content-center mt-3">
                    <a href="/addproduct" class="btn btn-primary mb-4 mr-3 mt-4"  style="background-color: #A55FA5">Tambah Produk</a>
                    <form action="/searchproduct" method='get' class="mt-4 w-50">
                        {{ csrf_field() }}
                        <div class="input-group">
                            <input type="search" name="search" id="search" class="form-control border " style="padding: 19px;" placeholder="Cari berdasarkan nama produk">
                    ...
                    <table class="table table-hover table-responsive m-auto align-items-center mb-3 ">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#view_{{ $produk->id }}">Detail</button> | 
                                <a href="editpr/{{ $produk->id }}" class="btn btn-warning">Edit</a> |
                                <button type="button" class="btn btn-behance" data-bs-toggle="modal" data-bs-target="#review_{{ $produk->id }}">Review</button> | 
                                <a href="delete-produk/{{ $produk->id }}" onclick="return confirm('Yakin mau hapus ?')" class="btn btn-danger">Delete</a></td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <img src="storage/{{ $produk->image }}" alt="" width="100%">
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <p><b class="text-center">Deskripsi</b> : {!! $produk->deskripsi !!}</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                {{-- Review --}}
                                <div class="modal fade" id="review_{{ $produk->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Review Produk</h5>
                                            <button type="button" class="btn btn-close" data-bs-dismiss="modal_review" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                
                                                @foreach ($review as $re)
                                                    @if ($produk->id === $re->products_id )
                                                        <div class="row m-auto">
                                                            <ul>
                                                                <li><b>{{ $re->user->name }}</b> : {!! $re->body !!}</li>
                                                            </ul>
                                                        </div>
                                                    @endif
