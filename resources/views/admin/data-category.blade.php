                ...
                <div class="card-body px-0 pb-2 m-auto  w-95"> 
                        <table class="table table-hover table-responsive m-auto align-items-center" id="table-data">
                                ...
                                <tr class="text-center ">
                                    <td>1</td>
                                    <td>Kucing</td>
                                    <td ><img src="/img/Kategori/kategoriKucing.svg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/kategoriKucing.svg" width="80%" alt="">
                                                            </div>
                                ...
                                <tr class="text-center ">
                                    <td>2</td>
                                    <td>Wet Food</td>
                                    <td ><img src="/img/Kategori/kategoriWetFood.svg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/kategoriWetFood.svg" width="80%" alt="">
                                                            </div>
                                                            <div class="col-md-6 text-left">
                                ...
                                <tr class="text-center ">
                                    <td>3</td>
                                    <td>Dry Food</td>
                                    <td ><img src="/img/Kategori/kategoriDryFood.svg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/kategoriDryFood.svg" width="80%" alt="">
                                                            </div>
                                                            <div class="col-md-6 text-left">
                                ...
                                <tr class="text-center ">
                                    <td>4</td>
                                    <td>Cat Toys</td>
                                    <td ><img src="/img/Kategori/kategoriMainan.svg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/kategoriMainan.svg" width="80%" alt="">
                                                            </div>
                                                            <div class="col-md-6 text-left">
                                ...
                                <tr class="text-center ">
                                    ...
                                    <td ><img src="/img/Kategori/kategoriPerlengkapan.svg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/kategoriPerlengkapan.svg" width="80%" alt="">
                                                            </div>
                                                            <div class="col-md-6 text-left">
                                ...
                                <tr class="text-center ">
                                    <td>6</td>
                                    <td>Obat Kucing</td>
                                    <td ><img src="/img/Kategori/KategoriObat.jpg" style="width: 30%"></td>
                                    <td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <img src="/img/Kategori/KategoriObat.jpg" width="80%" alt="">
                                                            </div>
                                                            <div class="col-md-6 text-left">
